...
import logoImage from './../../Images/logo_default.png';
...
<div class="nav__holder nav--sticky w-100">
  <div class="container relative">
    <div class="flex-parent">
      ...
      <img className="logo__img" src={logoImage} srcSet={`${logoImage} 1x, ${logoImage} 2x`} alt="logo" />
</a>
      ...
      <nav class="flex-child nav__wrap d-none d-lg-block">
        <ul class="nav__menu">
          ...
          <li class="nav__dropdown">
            <a href="#">Posts</a>
            <ul className="nav__dropdown-menu nav__megamenu w-100" style={{ width: "1218px", left: "-236.109px" }}>
