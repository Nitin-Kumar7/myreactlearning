                ...
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-70">
                      <img data-src="img/content/grid/grid_post_1.jpg" src="img/content/grid/grid_post_1.jpg" class="entry__img lazyloaded" alt=""/>
                    </div>
                  </a>
            ...
            <div class="col-md-6">
              <article class="entry card">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-70">
                      <img data-src="img/content/grid/grid_post_2.jpg" src="img/content/grid/grid_post_2.jpg" class="entry__img lazyloaded" alt=""/>
                    </div>
                  </a>
            ...
            <div class="col-md-6">
              <article class="entry card">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-70">
                      <img data-src="img/content/grid/grid_post_3.jpg" src="img/content/grid/grid_post_3.jpg" class="entry__img lazyloaded" alt=""/>
                    </div>
                  </a>
            ...
            <div class="col-md-6">
              <article class="entry card">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-70">
                      <img data-src="img/content/grid/grid_post_4.jpg" src="img/content/grid/grid_post_4.jpg" class="entry__img lazyloaded" alt=""/>
                    </div>
                  </a>
        ...
        <li class="post-list-small__item">
          <article class="post-list-small__entry clearfix">
            <div class="post-list-small__img-holder">
              <div class="thumb-container thumb-100">
                <a href="single-post.html">
                  <img data-src="img/content/post_small/post_small_3.jpg" src="img/content/post_small/post_small_3.jpg" alt="" class="post-list-small__img--rounded lazyloaded"/>
                </a>
              </div>
            </div>
            <div class="post-list-small__body">
        ...
        <li class="post-list-small__item">
          <article class="post-list-small__entry clearfix">
            <div class="post-list-small__img-holder">
              <div class="thumb-container thumb-100">
                <a href="single-post.html">
                  <img data-src="img/content/post_small/post_small_4.jpg" src="img/content/post_small/post_small_4.jpg" alt="" class="post-list-small__img--rounded lazyloaded"/>
                </a>
              </div>
            </div>
            <div class="post-list-small__body">
...
<section class="section mb-0">
  <div class="title-wrap title-wrap--line title-wrap--pr">
   ...
   Slider 
  <div id="owl-posts" class="owl-carousel owl-theme owl-carousel--arrows-outside owl-loaded owl-drag">
    
    
    
    
    
  <div class="owl-stage-outer"><div class="owl-stage" style={{transform: 'translate3d(-1248px, 0px, 0px)', transition: 'all 0s ease 0s', width: '4056px'}}><div class="owl-item cloned" style={{width: '282px', marginRight: '30px'}}><article class="entry thumb thumb--size-1">
      <div class="entry__img-holder thumb__img-holder" style={{backgroundImage: "url('Images/content/carousel/carousel_post_4.jpg')"}}>
    ...
    </article></div><div class="owl-item cloned" style={{width: '282px', marginRight: '30px'}}><article class="entry thumb thumb--size-1">
      <div class="entry__img-holder thumb__img-holder"style={{backgroundImage: "url('Images/content/carousel/carousel_post_4.jpg')"}}>
        <div class="bottom-gradient"></div>
        <div class="thumb-text-holder">   
          <h2 class="thumb-entry-title">
    ...
    </article></div><div class="owl-item active" style={{width: '282px', marginRight: '30px'}}><article class="entry thumb thumb--size-1">
      <div class="entry__img-holder thumb__img-holder" style={{backgroundImage: "url('Images/content/carousel/carousel_post_4.jpg')"}}>
        <div class="bottom-gradient"></div>
        <div class="thumb-text-holder">   
          <h2 class="thumb-entry-title">
    ...
    </article></div><div class="owl-item"  style={{width: '282px', marginRight: '30px'}}><article class="entry thumb thumb--size-1">
      <div class="entry__img-holder thumb__img-holder"style={{backgroundImage: "url('Images/content/carousel/carousel_post_4.jpg')"}}>              
        <div class="bottom-gradient"></div>
        <div class="thumb-text-holder">   
          <h2 class="thumb-entry-title">
    ...
    </article></div></div></div><div class="owl-nav"><div class="owl-prev"><i class="ui-arrow-left"></i></div><div class="owl-next"><i class="ui-arrow-right"></i></div></div><div class="owl-dots disabled"></div></div>  end slider 
      ...
      <div class="row">
        <div class="col-lg-6">
          <article class="entry thumb thumb--size-2">
            <div class="entry__img-holder thumb__img-holder" style={{backgroundImage: "url('img/content/thumb/thumb_post_1.jpg')"}}>
              <div class="bottom-gradient"></div>
        ...
        <div class="entry__img-holder card__img-holder">
          <a href="single-post.html">
            <div class="thumb-container thumb-65">
              <img data-src="img/content/grid/grid_post_5.jpg" src="img/content/grid/grid_post_5.jpg" class="entry__img lazyloaded" alt=""/>
            </div>
          </a>
    ...
    <div class="col-md-6">
      <article class="entry card">
        <div class="entry__img-holder card__img-holder">
          <a href="single-post.html">
            <div class="thumb-container thumb-65">
              <img data-src="img/content/grid/grid_post_6.jpg" src="img/content/grid/grid_post_6.jpg" class="entry__img lazyloaded" alt=""/>
            </div>
          </a>
          <div class="entry__play-time"><i class="ui-play"></i>3:21</div>
        </div>
  ...
  <div class="col-lg-8 blog__content mb-72">
    ...
    <section class="section">
      ...
      <article class="entry card post-list">
        <div class="entry__img-holder post-list__img-holder card__img-holder" style={{backgroundImage: "url('img/content/list/list_post_1.jpg')"}}>
          <a href="single-post.html" class="thumb-url"></a>
        ...
        <div class="entry__img-holder">
          <a href="single-post.html">
            <div class="thumb-container thumb-60">
              <img data-src="img/content/review/review_post_1.jpg" src="img/content/review/review_post_1.jpg" class="entry__img lazyloaded" alt=""/>
            </div>
          </a>
        </div>
